...
**Read [[CLAUDE]] first** — the three-layer memory rule, cross-surface boundary, session protocol.
...
- [[skills/long_form_scripting]] — the creative engine: structure, hooks, retention, delivery system (v1).
- [[skills/hyperframes_production]] — ⚠️ STUB; real skill lives only in the web project — paste needed.
