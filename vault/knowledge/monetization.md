...
## Calibrated by real data (2026-06-30 — protected; no false hope)
- $10K/month from ads alone: ~500K–1M monthly views in a high-RPM niche, 1–2+ years
  in; most channels never get there. **Treat $10K as the ceiling, not the target.**
- Proven small channels in OUR locked niche (25–32k subs, ~1yr+) pull **~$0.6–2.8k/mo
...
early lever; recurring SaaS commissions compound. 3. **Sponsorships** — pitch once the
audience is focused. 4. **Own product / newsletter / lead-gen** — highest-margin endgame.

## Affiliate programs (Video #1 stack — terms as of ~Jun 2026, RE-VERIFY per publish)
| Tool | Terms | Network | Note |
|---|---|---|---|
| **ElevenLabs** | 22% recurring / 12 mo | PartnerStack | **Primary lever.** Free tier = NO commercial rights; Starter (~$5, sources disagree $5 vs $6) = first monetizable tier; Flash/Turbo = ½ credits |
| Pictory | 20–50% recurring | FirstPromoter | |
| InVideo | 50% / 25% first-cycle only | Impact | No compounding |
| Canva | gated (Canvassador) | — | Don't block on it |
| ChatGPT / CapCut / DaVinci / Pexels | no affiliate | — | Link anyway — trust is the moat |

Rules that bind (from the skill): commission model > headline rate (recurring beats
one-time); disclosure at top of description AND spoken; track cookie window + payout
minimum + network per program; prices spoken as approximate, precise dated figures in
the fact-check table; never shill a worse product for a bigger payout.
