...
- **Freight brokerage — REJECTED.** Low ceiling (max 430K, zero ≥500K); zero
  small-channel breakouts across 356 videos; demand = "become a broker" course content.
- **HVAC — PARKED.** Best early newcomer signal (9K-sub channel → 515K) but it was a
  *buyer's guide*, not an explainer; demand skews trade/career. Durable lesson kept:
  buyer's-guide format is newcomer-winnable.
- **Self-storage — GATE 1 FAILED (2026-06-30).** Strong Reddit emotion (2.8K-upvote
...
- **Pure HyperFrames tutorial — SOFT-FAILED Gate 1 (2026-07-04).** Every genuinely-
  ...
  can now edit video — honest hands-on review" (Chronixel 8k→142K proof), and even then
  as a launch/authority piece, NOT a money video (open-source tool, no affiliate).
