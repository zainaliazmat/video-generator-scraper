#!/usr/bin/env bash
# US-English VO for needs-vs-wants-en. Voice: ElevenLabs "Brian" (American male narrator).
set -e
cd /home/zain-ali/Documents/YoutubeScraper/studio/videos/needs-vs-wants-en
